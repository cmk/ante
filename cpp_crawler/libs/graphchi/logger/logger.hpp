...
struct log_dispatch<false> {
  inline static void exec(int,const char*,const char*,
				int,const char*, ... ) {}
};
...
struct null_stream {
  ...
  inline null_stream operator<<(const char*) { return null_stream(); }
  inline null_stream operator<<(std::ostream& (*)(std::ostream&)) { return null_stream(); }
};
...
struct log_stream_dispatch<false> {
  inline static null_stream exec(int,const char*,const char*, int) {
    return null_stream();
  }
};
